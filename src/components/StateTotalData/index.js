...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo: 'https://res.cloudinary.com/dh8g4sctp/image/upload/v1706628227/covid19db/nuxmo5ydafjqqgynzlwv.png',
      value: totalConfirmed,
    }

    const activeData = {
      name: 'Active',
      logo: 'https://res.cloudinary.com/dh8g4sctp/image/upload/v1706628226/covid19db/nmkdfhtsxffcd21k0lx4.png',
      value: totalActive,
    }

    const recoveredData = {
      name: 'Recovered',
      logo: 'https://res.cloudinary.com/dh8g4sctp/image/upload/v1706628226/covid19db/rxfbwtl1zsszilvvt2b3.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo: 'https://res.cloudinary.com/dh8g4sctp/image/upload/v1706628226/covid19db/meswiidc1cvfpdg41s5s.png',
      value: totalDeceased,
    }
